...
(function () {
    ...
    */
    ...
    function setEventListeners() {
        var burgerButton = document.querySelector('.js-burgerButton');
        burgerButton.addEventListener('click', openMenu);
        var $sliderControl = $('.js-SectionSliderContaner');
        ...
        var $sendFormButton = $('[data-contactButton]');
        $sendFormButton.on('click', function (event) {
            sendContactForm(event);
        });
        var privacyLink = document.querySelector('.js-privacyTermsButton');
        ...
        var closeTermsButton = document.querySelector('[data-terms="closeButton"]');
    ...
    function openMenu() {
        var navMenu = document.querySelector('.js-navigationContainer');
    ...
    function setImgSlider() {
        var imgAssetsArray = ['./assets/wallhaven-119368blur.jpg', './assets/wallhaven-84321blur.jpg', './assets/wallhaven-187092blur.jpg', './assets/wallhaven-113384blur.png'];
        var slideImgBoxArray = document.querySelectorAll('.js-SectionSliderContaner-img');
    ...
    */
    ...
    function mapsInit() {
        ...
        if (GMaps) {
            //verify if the script tag of gmaps.js is loaded
            var map = new GMaps({
                div: '#officeMap',
                lat: latOffice,
                lng: lngOffice
